...
namespace OpenEventSourcing.EntityFrameworkCore.SqlServer.Infrastructure
{
    public class SqlServerJsonOptionsExtension : IDbContextOptionsExtension
    {
        ...
        private class SqlServerJsonOptionsExtensionInfo : DbContextOptionsExtensionInfo
        {
            ...
            public override void PopulateDebugInfo(IDictionary<string, string> debugInfo)
                => debugInfo["SqlServer:" + nameof(SqlServerDbContextOptionsExtensions.EnableJsonSupport)] = "1";
        }
    }
