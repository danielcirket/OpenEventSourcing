...
namespace OpenEventSourcing.RabbitMQ.Tests
{
    ...
    public class RabbitMqTestAttribute : FactAttribute, ITraitAttribute 
    {
        private readonly IConfiguration _configuration;

        public override string Skip { get; set; }

        public RabbitMqTestAttribute()
        {
            ...
            if (!HasRabbitMqConnectionString())
                Skip = $"Skipping RabbitMQ Test, no connection string configured.";
        }
